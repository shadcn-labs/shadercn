...
```bash
npx shadcn@latest add https://shadercn.vercel.app/r/orb-14.json
```
...
<ComponentSource
  src="components/orbs/orb-14/index.tsx"
  base="shadercn"
  title="components/orbs/orb-14/index.tsx"
/>

<ComponentSource
  src="components/orbs/orb-14/meta.ts"
  base="shadercn"
  title="components/orbs/orb-14/meta.ts"
/>

<ComponentSource
  src="components/orbs/orb-14/gpu.ts"
  base="shadercn"
  title="components/orbs/orb-14/gpu.ts"
/>
...
```tsx
import { Orb14 } from "@/components/orbs/orb-14";
```

```tsx
<Orb14 size={280} state="idle" />
```
...
| ---------- | ----------- | -------------- | ------- | ------- |
| `speed`    | Wave speed  | `0.015` – `10` | `0.05`  | `0.5`   |
| `spin`     | Roll        | `0` – `5`      | `0.03`  | `0.15`  |
| `radius`   | Radius      | `0.15` – `3`   | `0.015` | `0.9`   |
| `cells`    | Grid cells  | `32` – `320`   | `2`     | `140`   |
| `levels`   | Tone steps  | `2` – `8`      | `1`     | `3`     |
| `scale`    | Wave scale  | `0.3` – `12`   | `0.1`   | `1.5`   |
| `plasma`   | Wave amount | `0` – `3`      | `0.015` | `0.9`   |
| `light`    | Key light   | `0` – `3`      | `0.015` | `0.9`   |
