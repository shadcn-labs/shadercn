...
```bash
npx shadcn@latest add https://shadercn.vercel.app/r/orb-19.json
```
...
<ComponentSource
  src="components/orbs/orb-19/index.tsx"
  base="shadercn"
  title="components/orbs/orb-19/index.tsx"
/>

<ComponentSource
  src="components/orbs/orb-19/meta.ts"
  base="shadercn"
  title="components/orbs/orb-19/meta.ts"
/>

<ComponentSource
  src="components/orbs/orb-19/gpu.ts"
  base="shadercn"
  title="components/orbs/orb-19/gpu.ts"
/>
...
| `slide`      | Drift            | `0` – `4`      | `0.02`  | `0.1`   |
| `radius`     | Radius           | `0.15` – `3`   | `0.015` | `0.9`   |
| `scale`      | Packing scale    | `0.3` – `30`   | `0.1`   | `10`    |
| `bulge`      | Dome bulge       | `0` – `4`      | `0.02`  | `0.3`   |
| `grow`       | Dot size         | `-0.2` – `1.2` | `0.005` | `0.185` |
| `vary`       | Size variation   | `0` – `0.4`    | `0.005` | `0.13`  |
| `skew`       | Generator detune | `0` – `3`      | `0.01`  | `0.62`  |
| `jitter`     | Dot wander       | `0` – `1.5`    | `0.01`  | `0.1`   |
| `edge`       | Rim hardness     | `1` – `200`    | `1`     | `50`    |
| `bead`       | Bead shading     | `0` – `1`      | `0.01`  | `0`     |
| `gain`       | Brightness       | `0.05` – `4`   | `0.02`  | `1`     |
| `contrast`   | Contrast         | `0.15` – `6`   | `0.05`  | `1`     |
| `saturation` | Saturation       | `0` – `4`      | `0.02`  | `1.1`   |
| `floorLevel` | Body fill        | `0` – `2`      | `0.01`  | `0.06`  |
| `light`      | Key light        | `0` – `3`      | `0.015` | `0.3`   |
| `rim`        | Rim sheen        | `0` – `3`      | `0.015` | `0.35`  |
