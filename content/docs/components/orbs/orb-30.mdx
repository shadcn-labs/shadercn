...
```bash
npx shadcn@latest add https://shadercn.vercel.app/r/orb-30.json
```
...
<ComponentSource
  src="components/orbs/orb-30/index.tsx"
  base="shadercn"
  title="components/orbs/orb-30/index.tsx"
/>

<ComponentSource
  src="components/orbs/orb-30/meta.ts"
  base="shadercn"
  title="components/orbs/orb-30/meta.ts"
/>

<ComponentSource
  src="components/orbs/orb-30/gpu.ts"
  base="shadercn"
  title="components/orbs/orb-30/gpu.ts"
/>
